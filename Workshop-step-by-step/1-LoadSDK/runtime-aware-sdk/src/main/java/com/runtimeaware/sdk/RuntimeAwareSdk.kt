...
class RuntimeAwareSdk(private val context: Context) {
    ...
    suspend fun createFile(size: Long): Result<String?> {
        TODO("Get the SDK Service, call the createFile method, and return the result.")
    }
    ...
    suspend fun triggerProcessDeath() {
        TODO("Get the SDK Service, call the triggerProcessDeath method, and return the result.")
    }

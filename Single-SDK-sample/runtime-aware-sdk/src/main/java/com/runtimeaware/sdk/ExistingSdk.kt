...
import com.runtimeenabled.api.PaymentSdkServiceFactory
...
class ExistingSdk(private val context: Context) {
    ...
    internal companion object Loader {
        ...
        private var remoteInstance: PaymentSdkService? = null

        suspend fun loadSdkIfNeeded(context: Context): PaymentSdkService? {
            try {
                ...
                remoteInstance =
                    PaymentSdkServiceFactory.wrapToPaymentSdkService(sandboxedSdk.getInterface()!!)
                // Initialize SDK.

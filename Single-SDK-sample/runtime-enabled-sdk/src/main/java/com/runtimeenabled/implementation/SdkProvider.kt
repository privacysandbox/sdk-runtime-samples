...
/** Provides a [PaymentSdkService] implementation when the SDK is loaded. */
class SdkProvider : AbstractSandboxedSdkProviderCompat() {
    /**
     * Returns the [PaymentSdkService] implementation. Called when the SDK is loaded.
     *
     ...
     */
    override fun createPaymentSdkService(context: Context): PaymentSdkService = SdkServiceImpl(context)
}
